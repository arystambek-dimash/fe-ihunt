...
const AutoResponseLoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await axios.post('https://ihunt.azurewebsites.net/api/v1/users/auto-response/login', {
                email,
                password,
            });
    ...
    return (
        <div ref={vantaRef} className="flex min-h-screen justify-center bg-background px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-md mt-28 space-y-8">
                <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
                    <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-foreground">
                        Войдите в свой аккаунт Авто отклик AI
                    </h2>
...
export default AutoResponseLoginPage;
